...
class FacadeFragment: Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        tvBuilder.setText(R.string.facade)

        etvAdvantages.content = ArrayUtils.getString(context!!, R.array.facade_advantages)
        etvDisadvantages.content = ArrayUtils.getString(context!!, R.array.facade_disadvantages)
    }
}