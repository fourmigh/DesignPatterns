...
class TemplateFragment: Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        tvBuilder.setText(R.string.template)

        etvAdvantages.content = ArrayUtils.getString(context!!, R.array.template_advantages)
        etvDisadvantages.content = ArrayUtils.getString(context!!, R.array.template_disadvantages)
    }
}