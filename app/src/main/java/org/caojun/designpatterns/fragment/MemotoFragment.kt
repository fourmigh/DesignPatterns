...
class MemotoFragment: Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        tvBuilder.setText(R.string.memoto)

        etvAdvantages.content = ArrayUtils.getString(context!!, R.array.memoto_advantages)
        etvDisadvantages.content = ArrayUtils.getString(context!!, R.array.memoto_disadvantages)
    }
}