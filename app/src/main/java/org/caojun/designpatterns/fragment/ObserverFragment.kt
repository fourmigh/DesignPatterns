...
class ObserverFragment: Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        tvBuilder.setText(R.string.observer)

        etvAdvantages.content = ArrayUtils.getString(context!!, R.array.observer_advantages)
        etvDisadvantages.content = ArrayUtils.getString(context!!, R.array.observer_disadvantages)
    }
}